...
function injectNav() {
  ...
  <nav id="nav">
    ...
    <div class="nav-tabs">
      <a class="nav-tab" href="${homeHref}" data-page="home"><span data-i18n="nav_home">Home</span></a>
      <a class="nav-tab" href="${pageHref('chat.html')}" data-page="chat"><span class="nav-icon"></span> <span data-i18n="nav_chat">AI Chat</span></a>
